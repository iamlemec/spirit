import { MapMode, EditorSelection, EditorState, Transaction, Prec, Facet, StateEffect, RangeValue, RangeSet, ChangeSet, findClusterBreak, findColumn, Text, Annotation, codePointAt, codePointSize, countColumn, combineConfig, CharCategory, RangeSetBuilder } from '../../state/dist/index.js';
...
export { BidiSpan, BlockInfo, BlockType, Decoration, Direction, EditorView, GutterMarker, MatchDecorator, RectangleMarker, ViewPlugin, ViewUpdate, WidgetType, drawSelection, gutterLineClass, gutterWidgetClass, gutters, highlightSpecialChars, keymap, layer, lineNumberMarkers, lineNumberWidgetMarker, lineNumbers, logException };
